...
const SignUpPage = () => {
    ...
    return (
        <div className="bg-black flex flex-col md:flex-row w-screen h-screen pl-8 pt-8 md:pl-10 md:pt-10">
            <div className="w-full md:w-1/3 h-1/2 md:h-full flex flex-col justify-between pr-6">
                <h1 className="text-white text-2xl">Sign Up Page</h1>
                <p className="text-white/60 text-base md:text-base lg:text-xl">
